...
func TestSetupOptimizerHeadWiseSplitsQueryKey(t *testing.T) {
	...
	plainGroups := plainModel.SetupOptimizer(0.01, 0.1, 0.02, 0.28, 0.5)
	...
	headGroups := headModel.SetupOptimizer(0.01, 0.1, 0.02, 0.28, 0.5)
...
func TestHeadWiseMuonTrainStepFinite(t *testing.T) {
	...
	groups := transformer.SetupOptimizer(0.01, 0.1, 0.02, 0.28, 0.5)
